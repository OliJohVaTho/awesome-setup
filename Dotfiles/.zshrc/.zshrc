...
alias saver="cool-retro-term --fullscreen -e sh ~/cmatrix.sh"
alias rc="nvim ~/.config/awesome/rc.lua"
alias aliases="python3 /bin/print_aliases.py"
alias uio="cd ~/UiO"
alias master="cd ~/UiO/Master-Thesis/"
alias open="xdg-open"
