...
-- Keybindings for specific things
awful.key({modkey, "Shift"}, "d", function() xrandr.xrandr() end)
...
awful.spawn.with_shell("feh --no-fehbg --bg-fill --randomize ~/Pictures/Wallpaper/*")
